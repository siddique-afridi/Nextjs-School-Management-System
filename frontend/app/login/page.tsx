        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">Manage school, classes, and users</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">Manage classes and attendance</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">View attendance and results</div>
            </button>
          </div>
        </div>
      </div>
          ...
          {isStudent ? (
            <>
              <div>
                ...
                />
                {errors.rollNum && <p className="text-red-500 text-sm">{errors.rollNum.message}</p>}
              </div>
            ...
            <div>
              ...
              <input
                ...
                {...register("email")}
                placeholder={
                  selectedRole === UserRole.ADMIN ? "admin@school.com" : "teacher@school.com"
                }
                className="w-full rounded-lg border border-input bg-background px-4 py-2 text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              />
