...
import { complainCreate, complainList, myComplaints } from "../controllers/complainController.js";
import {
  noticeCreate,
  noticeList,
  deleteNotices,
...
router.post("/ComplainCreate", verify_Token, authorizeRoles("Admin", "Student"), complainCreate);
router.get("/ComplainList/:id", verify_Token, authorizeRoles("Admin"), complainList);
router.get("/MyComplaints", verify_Token, authorizeRoles("Student"), myComplaints);
